...
public class InnerClass extends JavaElement{
	...
	private QualifiedJavaType superClass;
	...
	public InnerClass(QualifiedJavaType type) {
		super();
		this.type = type;
    ...
    public String getFormattedContent(int indentLevel, CompilationUnit compilationUnit) {
        ...
        if (superInterfaceTypes.size() > 0) {
            ...
            for (QualifiedJavaType fqjt : superInterfaceTypes) {
                ...
                sb.append(fqjt.getBaseShortName());
//                compilationUnit.addImportedType(fqjt);
	 ...
	 */
	public void setSuperClass(QualifiedJavaType superClass) {
	...
	public void setSuperClass(String superClassType) {
		this.superClass = new QualifiedJavaType(superClassType);
	}
