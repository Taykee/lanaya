...
public class Method extends JavaElement {
	...
	private QualifiedJavaType returnType;
	...
	/** The exceptions. */
	private List<QualifiedJavaType> exceptions;
	...
	public Method(String name) {
		...
		exceptions = new ArrayList<QualifiedJavaType>();
		this.name = name;
	}
	...
	public String getFormattedContent(int indentLevel, boolean interfaceMethod, CompilationUnit compilationUnit) {
		...
		if (getExceptions().size() > 0) {
			...
			comma = false;
			for (QualifiedJavaType fqjt : getExceptions()) {
				if (comma) {
					sb.append(", "); //$NON-NLS-1$
				} else {
					comma = true;
	 ...
	 */
	public QualifiedJavaType getReturnType() {
		return returnType;
	}
	 ...
	 */
	public void setReturnType(QualifiedJavaType returnType) {
	 ...
	 */
	public List<QualifiedJavaType> getExceptions() {
		return exceptions;
	}
	 ...
	 */
	public void addException(QualifiedJavaType exception) {
